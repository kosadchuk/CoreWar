...
# define FLAG_ERR ERR	"After flag \"-n\" wrong player number : "
# define FLAG_ERR_2		"Please, try again from 1 to "
# define USG_TITLE USAGE"[-dump N] [-v N] [-n N] <champion.cor> <...>\n"
# define USG_D USG_TITLE"	-dump N : Dumps memory after N cycles then exits\n"
# define USG_N USG_D	"	-n N    : Сhange the order of champions\n"
...
# define WRONG_N_NUM ERR"The player number can't be more then their count!\n"
# define UNC_COMND		"is unknown command!\n"
# define ERR_FILE_READ ERR"in reading champion file!\n"
# define ERR_MG_HEADER ERR"Didn't find or incorrect magic header!\n"
# define NAME_COMM_ERR ERR"Champion's name/comment size so small!\n"
# define MISS_NULL ERR	"After name/comment miss NULL bytes!\n"
# define BOT_SIZE ERR	"Champion size is too big!\n"
# define ERR_CHAMP_NAME ERR"-> %s <- is invalid champion name!\n"
# define ERR_DUMP_NUM	"Wrong dump cycles number!\n"
# define ERR_FLAG_V ERR	"Wrong flag number\n"
